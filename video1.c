...
int main(int argc, char** argv)
{
	...
	CvCapture* capture = cvCreateFileCapture(argv[1]);//Carga la informacionm y frames de un archivo.avi, se inicia en primer frame, solo crea una frame y la recarga cada vez que es llamado
//	assert(capture != NULL);
	IplImage* frame;
	while (1){
